...
public enum AppState {
    ...
    static final protected int get_screen_metric() {

        return the_data.getInt(SCREEN_METRIC, 0);
    }

    //- Put the current version of the application on file.
    static final protected void put_screen_metric(final int this_metric) {
        final SharedPreferences.Editor the_editor = the_data.edit();
    ...
    //- Get the version of the application on file.
    static final protected int get_last_position() {

        return the_data.getInt(LAST_POSITION, 0);
    }

    //- Put the current version of the application on file.
    static final protected void put_last_position(final int this_position) {
        final SharedPreferences.Editor the_editor = the_data.edit();
    ...
    static final protected Boolean put_sort_direction(final Boolean sort_direction) {
        final SharedPreferences.Editor the_editor = the_data.edit();
    ...
    //- Set our sort direction -- false is 'Ascending', true is 'Descending'
    static final protected String get_sort_direction() {
